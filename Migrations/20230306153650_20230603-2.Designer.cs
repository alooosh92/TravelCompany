...
namespace TravelCompany.Migrations
{
    ...
    [Migration("20230306153650_20230603-2")]
    partial class _202306032
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelCompany.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("personInfouserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TravelCompany.Models.Booking", b =>
                {
                    b.HasOne("TravelCompany.Models.PersonInfo", "personInfo")
                        .WithMany()
                        .HasForeignKey("personInfouserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
